...
import { Menu, Home, Building, User, LogOut } from "lucide-react"
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar"
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet"
import { cn } from "@/lib/utils"

export default function LandlordNavigation() {
    ...
    <>
      ...
      <header className="hidden border-b border-gray-200 bg-white md:block">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-8">
            <Link href="/landlord" className="text-xl font-bold text-teal-600">
              HomeHaven
            </Link>
      ...
      <header className="fixed top-0 z-50 w-full border-b border-gray-200 bg-white md:hidden">
        <div className="container mx-auto flex h-14 items-center justify-between px-4">
          <Link href="/landlord" className="text-lg font-bold text-teal-600">
            HomeHaven
          </Link>
