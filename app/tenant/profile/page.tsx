        ...
        <div className="md:col-span-1">
          <Card className="rounded-[1.5rem] border-0 shadow-md">
            <CardHeader className="flex flex-col items-center text-center">
              ...
              <CardDescription>{user?.role === "tenant" ? "Tenant" : "Landlord"}</CardDescription>
            </CardHeader>
          ...
          <Tabs defaultValue="account" className="w-full">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-xl border border-gray-200 p-4">
                      ...
                      <p className="text-sm text-gray-500">{formData.address || "No address provided"}</p>
                    </div>
            ...
            <TabsContent value="notifications">
              <Card className="rounded-[1.5rem] border-0 shadow-md">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Receive reminders when rent is due</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Receive property recommendations</p>
                        </div>
                        <Switch />
                      </div>
                    </div>
                ...
                <CardFooter>
                  <Button className="rounded-full bg-teal-600 hover:bg-teal-700">Save Preferences</Button>
                </CardFooter>
              </Card>
            </TabsContent>
